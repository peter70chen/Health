    ...
    <div className="bg-neutral-900 rounded-2xl border border-neutral-800 p-6">
      ...
      <form onSubmit={handleWeightSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select value={inputDose} onChange={e => setInputDose(e.target.value)} className="w-full p-3 bg-neutral-800 border border-neutral-700 rounded-xl text-sm font-bold text-neutral-300 outline-none focus:border-teal-500 appearance-none cursor-pointer">
