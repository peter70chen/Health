...
- **建置工具**: Vite 5
- **樣式**: TailwindCSS 3
- **AI**: Google Gemini API (`gemini-3.5-flash`, with automatic fallback)
...
應用程式需要 Google Gemini API Key 才能使用 AI 功能，目前照片食物辨識模型優先使用 Gemini 3.5 Flash (`gemini-3.5-flash`)，若暫時不可用會自動備援到 Flash-Lite / 2.5 系列：
