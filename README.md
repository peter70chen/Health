...
- 📱 **飲食記錄** - AI 圖片辨識或手動輸入
- 🥬 **四大營養素** - 蛋白質／碳水／脂肪／膳食纖維，AI 依食材類型估算纖維
...
- **建置工具**: Vite 5
- **樣式**: TailwindCSS 3
- **AI**: Google Gemini API (`gemini-3.6-flash`, with automatic fallback)
...
應用程式需要 Google Gemini API Key 才能使用 AI 功能，目前照片食物辨識模型優先使用 Gemini 3.6 Flash (`gemini-3.6-flash`)，若暫時不可用會自動備援到 3.5 Flash / Flash-Lite / 2.5 系列：
